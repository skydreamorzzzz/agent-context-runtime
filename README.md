...
Implementation status: this commit establishes the file and responsibility boundaries only. It does not claim a runnable provider, evaluator, or experimental result.
